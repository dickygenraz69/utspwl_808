                                    ...
                                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="<?php echo base_url();?>admin/simpanlaundry" onsubmit = "return cekform();">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">                                                
                                                <input type="text" class="form-control has-feedback-left" id="single_cal4" id="tgl_masuk" name="tgl_masuk" placeholder="Masukan tanggal dengan format bulan/hari/tahun" aria-describedby="inputSuccess2Status4" value="<?php echo $tgl_masuk; ?>">
                                            </div>
                                        </div>
                                       <div class="form-group">
